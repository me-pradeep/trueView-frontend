...
function Profile({ username }) {
  ...
  if (loading) {
    return (
      <div className="w-[80%] max-lg:w-[80%] max-md:w-[100%] bg-white rounded-lg flex gap-4 p-4">
        <Skeleton
          variant="circular"
          width={100}
          height={100}
  ...
  return (
    <div className="w-[80%] bg-white rounded-lg flex gap-4 p-4 max-lg:flex-col max-lg:w-full">
      ...
      <div className=" flex max-lg:w-full justify-center gap-4 border-l-2 max-lg:border-l-0 max-lg:border-t-2 max-lg:pt-2 pl-2 border-slate-400 items-center max-lg:justify-center">
        <div className="flex flex-col items-center font-semibold">
          {numOfRatingsGiven}
          <div className="text-center text-slate-400">Ratings Given</div>
        </div>
        <div className="flex flex-col items-center font-semibold">
          {numOfRatingsReceived}
          <div className="text-center text-slate-400">Ratings Received</div>
        </div>
        <div className="flex flex-col items-center font-semibold">
          {overallRating}/10
          <div className="text-center text-slate-400">Average Rating</div>
        </div>
        <div className="flex flex-col items-center font-semibold">
          {ratingCount}
          <div className="text-center text-slate-400">Rating Count</div>
        </div>
      </div>
    </div>
  );
